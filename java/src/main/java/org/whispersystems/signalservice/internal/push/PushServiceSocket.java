...
public class PushServiceSocket {
  ...
  private static final String CREATE_ACCOUNT_SMS_PATH   = "/v1/accounts/sms/code/%s/%s";
  private static final String CREATE_ACCOUNT_VOICE_PATH = "/v1/accounts/voice/code/%s/%s";
      ...
      OkHttpClient     okHttpClient     = connectionHolder.getClient().newBuilder()
                                                          ...
                                                          .authenticator(new okhttp3.Authenticator() {
                                                            ...
                                                            public Request authenticate(Route route, Response response) throws IOException {
                                                              String credential = Credentials.basic("spikadAdminAPI471", "79aeW252wQ28cV0v77eH167470Aa7689Qqkfr");
  ...
  /*
 * METODO DA USARE AL POSTO DI trustManagers, per bypassare la validazione SSL
